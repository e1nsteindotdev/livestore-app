...
import type { IntentionalShutdownCause, MaterializerHashMismatchError, SqliteError, SyncError, UnexpectedError } from './errors.ts';
...
export interface ClientSession {
    ...
    shutdown: (cause: Exit.Exit<IntentionalShutdownCause, UnexpectedError | SyncError | MaterializerHashMismatchError>) => Effect.Effect<void>;
...
export interface AdapterArgs {
    ...
    shutdown: (exit: Exit.Exit<IntentionalShutdownCause, UnexpectedError | SyncError | MaterializerHashMismatchError | InvalidPullError | SqliteError | IsOfflineError>) => Effect.Effect<void>;
