...
import { State } from '../schema/mod.ts';
...
export declare const schema: import("../schema/schema.ts").FromInputSchema.DeriveSchema<{
    state: import("../schema/schema.ts").InternalState;
    events: {
