    ...
    describe('materializer', () => {
      ...
      `);
        ...
        test('struct value (partial set=true)', () => {
            expect(forSchema(Schema.Struct({ a: Schema.String }), { a: 'hello' }, 'id1', { partialSet: true })).toMatchInlineSnapshot(`
          {
            "bindValues": [
              "id1",
              "{"a":"hello"}",
        ...
        test('struct value (partial set=false)', () => {
            expect(forSchema(Schema.Struct({ a: Schema.String }), { a: 'hello' }, 'id1', { partialSet: false })).toMatchInlineSnapshot(`
        {
          "bindValues": [
            "id1",
            "{"a":"hello"}",
