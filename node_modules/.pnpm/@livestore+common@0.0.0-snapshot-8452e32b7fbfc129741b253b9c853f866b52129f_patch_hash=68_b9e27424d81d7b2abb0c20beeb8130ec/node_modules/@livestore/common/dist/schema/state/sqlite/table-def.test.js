...
describe('table function overloads', () => {
    ...
    it('should work with columns parameter', () => {
        ...
        expect(todosTable.rowSchema.fields.optionalBoolean.toString()).toBe('(number <-> boolean) | null');
        expect(todosTable.sqliteDef.columns.optionalComplex.nullable).toBe(true);
        expect(todosTable.sqliteDef.columns.optionalComplex.schema.toString()).toBe('(parseJson <-> { readonly color: string } | undefined) | null');
    ...
    it('should properly infer types from schema', () => {
        ...
        expect(userTable.rowSchema.fields.age.toString()).toMatchInlineSnapshot(`"Int"`);
        expect(userTable.rowSchema.fields.active.toString()).toMatchInlineSnapshot(`"(number <-> boolean)"`);
        expect(userTable.rowSchema.fields.metadata.toString()).toMatchInlineSnapshot(`"(parseJson <-> { readonly [x: string]: unknown }) | null"`);
