    ...
    describe('write operations', () => {
      ...
      `);
        ...
        it('should handle INSERT queries with undefined values', () => {
            expect(dump(db.todos.insert({ id: '123', text: 'Buy milk', status: 'active', completed: undefined }))).toMatchInlineSnapshot(`
        {
          "bindValues": [
            "123",
            "Buy milk",
      ...
      `);
        ...
        it('should handle UPDATE queries with undefined values', () => {
            expect(dump(db.todos.update({ status: undefined, text: 'some text' }).where({ id: '123' }))).toMatchInlineSnapshot(`
        {
          "bindValues": [
            "some text",
            "123",
