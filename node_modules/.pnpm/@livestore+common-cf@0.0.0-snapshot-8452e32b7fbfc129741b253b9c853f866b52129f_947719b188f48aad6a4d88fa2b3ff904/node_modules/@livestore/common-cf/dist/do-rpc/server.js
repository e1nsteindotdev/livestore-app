...
export const toDurableObjectHandler = (group, options) => (serializedPayload) => Effect.gen(function* () {
    ...
    for (const request of requests) {
        ...
        const result = yield* Effect.gen(function* () {
            const handlerResult = entry.handler(request.payload, Headers.fromInput({
...
export const emitStreamResponse = ({ callerContext, env, requestId, values, }) => Effect.gen(function* () {
