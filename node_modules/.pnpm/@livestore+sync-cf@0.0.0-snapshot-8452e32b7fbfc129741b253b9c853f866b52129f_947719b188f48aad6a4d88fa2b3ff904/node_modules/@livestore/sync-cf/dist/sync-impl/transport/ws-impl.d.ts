...
import { Effect, type Scope, WebSocket } from '@livestore/utils/effect';
...
export declare const makeCfSync: (options: WsSyncOptions) => SyncBackend.SyncBackendConstructor<SyncMetadata>;
