import { Layer, type Rpc, RpcClient, type RpcGroup, RpcSerialization } from '@livestore/utils/effect';
 ...
 */
export declare const layerProtocolDurableObject: (callRpc: (payload: unknown) => Promise<unknown>) => Layer.Layer<RpcClient.Protocol, never, RpcSerialization.RpcSerialization>;
/**
...
//# sourceMappingURL=protocol-durable-object.d.ts.map