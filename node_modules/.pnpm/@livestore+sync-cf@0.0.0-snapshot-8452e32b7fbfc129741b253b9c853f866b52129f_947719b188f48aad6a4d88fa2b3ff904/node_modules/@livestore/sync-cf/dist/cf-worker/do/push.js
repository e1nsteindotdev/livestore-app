...
export const makePush = ({ storage, options, rpcSubscriptions, currentHeadRef, storeId, payload, ctx, env, }) => (pushRequest) => Effect.gen(function* () {
...
})), Effect.mapError((cause) => cause._tag === 'LiveStore.UnexpectedError' ? SyncMessage.SyncError.make({ cause, storeId }) : cause));
/**
