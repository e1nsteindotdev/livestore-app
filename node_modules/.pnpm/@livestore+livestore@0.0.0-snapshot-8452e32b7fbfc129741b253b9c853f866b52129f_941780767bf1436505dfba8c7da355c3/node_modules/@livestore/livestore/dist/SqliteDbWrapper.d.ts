...
export declare class SqliteDbWrapper implements SqliteDb {
    ...
    get debug(): import("@livestore/common").SqliteDebugInfo;
    get metadata(): any;
    prepare(queryStr: string): PreparedStatement;
    import(data: Uint8Array<ArrayBuffer> | SqliteDb<any, any>): void;
    close(): void;
    destroy(): void;
    ...
    select: {
        ...
        <T>(queryBuilder: import("@livestore/common").QueryBuilder<T, any, any>): T;
    };
