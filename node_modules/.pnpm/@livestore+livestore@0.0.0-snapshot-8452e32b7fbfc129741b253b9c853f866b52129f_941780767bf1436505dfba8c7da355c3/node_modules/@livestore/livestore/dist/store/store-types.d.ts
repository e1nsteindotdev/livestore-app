import type { ClientSession, ClientSessionSyncProcessorSimulationParams, IntentionalShutdownCause, InvalidPullError, IsOfflineError, MaterializerHashMismatchError, SqliteError, StoreInterrupted, SyncError, UnexpectedError } from '@livestore/common';
...
export type ShutdownDeferred = Deferred.Deferred<IntentionalShutdownCause, UnexpectedError | SyncError | StoreInterrupted | MaterializerHashMismatchError | InvalidPullError | SqliteError | IsOfflineError>;
