...
export const addFinalizerLog = (...msgs) => Effect.addFinalizer((exit) => Effect.log(...msgs, exit._tag === 'Success' ? 'with success' : `with failure: ${Cause.pretty(exit.cause)}`));
...
export const withPerformanceMeasure = (meaureLabel) => (eff) => Effect.acquireUseRelease(Effect.sync(() => globalThis.performance.mark(`${meaureLabel}:start`)), () => eff, () => Effect.sync(() => {
