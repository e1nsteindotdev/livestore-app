 ...
 * for many Web APIs.
 */
export const ensureUint8ArrayBuffer = (array) => {
 ...
 */
export const textEncodeToArrayBuffer = (text) => {
 ...
 */
export const isUint8ArrayBuffer = (array) => {
 ...
 */
export const toUint8ArrayBuffer = (array) => {
